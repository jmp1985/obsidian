...
class FeatureExtractor():
  ...
  def mean_traces(self, rmax, nangles, centre=None):
    ...
    :param int nangles: number of lines to average over: 
                        the higher the more representative the extracted profile data
    :return: list of mean profile vectors extracted from image collection 
    '''      
    if rmax is None:
      print(("Warning: rmax either not specified or exceeded image dimensions. \
